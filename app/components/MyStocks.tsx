...
const stocks = [
  { name: 'Nvidia', symbol: 'NVDA', value: '203.65', change: '+5.63', color: 'bg-green-100', chartColor: '#22c55e', points: "0,30 20,20 40,25 60,15 80,10 100,18" },
  { name: 'Meta', symbol: 'META', value: '151.74', change: '-4.44', color: 'bg-purple-100', chartColor: '#a855f7', points: "0,10 20,15 40,12 60,25 80,30 100,22" },
  { name: 'Tesla Inc', symbol: 'TSLA', value: '177.90', change: '+17.63', color: 'bg-yellow-100', chartColor: '#f59e0b', points: "0,35 20,30 40,10 60,15 80,5 100,12" },
  { name: 'Apple Inc', symbol: 'AAPL', value: '145.93', change: '+23.41', color: 'bg-blue-100', chartColor: '#3b82f6', points: "0,20 20,25 40,15 60,18 80,10 100,5" },
  { name: 'Advanced Micro', symbol: 'AMD', value: '75.40', change: '+25.45', color: 'bg-red-100', chartColor: '#ef4444', points: "0,15 20,10 40,20 60,25 80,35 100,30" },
];
